...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\احمد شعبان\Desktop\first_django\management'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\احمد شعبان\Desktop\first_django\management\Scripts\deactivate.nu'
